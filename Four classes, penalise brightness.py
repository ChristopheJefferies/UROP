...
class0, class1 = 0, 3 # Initial image and target adversarial label
...
n_steps = 5000
lr = 1
fadefactor = 0.3 # How much to penalise brightness in adversarial image (hopefully reduces noise)
...
def create_plot_adversarial_images(x_image, y_label, lr=0.1, n_steps=5):
    ...
    for i in range(n_steps):
        ...
        if (i%(n_steps//5) == 0) or (i == n_steps-1):
            plot_predictions(img_adv_list, plot_number = i/(n_steps//5) +1)
