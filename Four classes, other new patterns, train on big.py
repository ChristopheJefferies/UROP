...
# Make train data
trainindex = n_train_images*[0] + n_train_images*[1] #indices, 100 of each type
...
# Make test data
testindex = n_test_images*[0] + n_test_images*[1]
...
W_fc2 = weight_variable([n_dense, 2])
...
chosenlabel = to_categorical(class1, num_classes = 2) # adversarial label 0
...
n_steps = 5000
lr = 0.8
fadefactor = 0.05 # How much to penalise brightness in adversarial image (hopefully reduces noise)
