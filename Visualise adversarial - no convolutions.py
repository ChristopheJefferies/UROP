...
# Dense layer 1
W_fc1 = weight_variable([64, n_dense1])
b_fc1 = bias_variable([n_dense1])
x_fc1 = tf.nn.relu(tf.matmul(x, W_fc1) + b_fc1)

# Dense layer 2
W_fc2 = weight_variable([n_dense1, n_dense2])
b_fc2 = bias_variable([n_dense2])
x_fc2 = tf.nn.relu(tf.matmul(x_fc1, W_fc2) + b_fc2)

# Regularization with dropout
keep_prob = tf.placeholder(tf.float32)
x_fc1_drop = tf.nn.dropout(x_fc2, keep_prob)

# Classification layer and output
W_fc3 = weight_variable([n_dense2, 4])
